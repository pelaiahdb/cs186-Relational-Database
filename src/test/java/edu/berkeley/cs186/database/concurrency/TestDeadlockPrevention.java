...
public class TestDeadlockPrevention {
  ...
  public void testIfWorkingLock() throws InterruptedException {
  ...
  @Category(StudentTestP3.class)
  public void testIfWorkingLock2() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
  ...
  @Category(StudentTestP3.class)
  public void testIfWorkingLock3() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("D", 1, LockManager.LockType.SHARED);
      }
    }, "Transaction 1 Thread");

    AsyncDeadlockTesterThread thread2 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("D", 2, LockManager.LockType.SHARED);
      }
    }, "Transaction 2 Thread");
  ...
  @Category(StudentTestP3.class)
  public void testIfWorkingLock4() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
  ...
  @Category(StudentTestP3.class)
  public void testIfWorkingLock5() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
